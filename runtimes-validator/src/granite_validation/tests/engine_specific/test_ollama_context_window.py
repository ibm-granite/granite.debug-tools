...
from granite_validation.tests.common.test_long_input import WAR_AND_PEACE_PASSAGE
...
class OllamaContextWindowTest(AbstractValidationTest):
    ...
    def _check_long_input(
        ...
        try:
            ...
            checks.append(CheckResult(
                name="long_input_num_ctx_error", passed=False, detail=str(e),
            ))
            return
    ...
    def _check_context_exhaustion(
        ...
        try:
            ...
            checks.append(CheckResult(
                name="context_exhaustion_error", passed=False, detail=str(e),
            ))
            return
    ...
    def _check_context_continuation(
        ...
        try:
            ...
            checks.append(CheckResult(
                name="context_continuation_first_error", passed=False, detail=str(e),
            ))
            return
        ...
        try:
            ...
            checks.append(CheckResult(
                name="context_continuation_second_error", passed=False, detail=str(e),
            ))
            return
