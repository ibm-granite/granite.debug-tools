...
class OllamaPerformanceTest(AbstractValidationTest):
    ...
    def _check_load_time(
        ...
        try:
            ...
            checks.append(CheckResult(
                name="load_time_unload_error", passed=False, detail=str(e),
            ))
            return
        ...
        try:
            ...
            checks.append(CheckResult(
                name="load_time_reload_error", passed=False, detail=str(e),
            ))
            return
    ...
    def _check_prompt_eval(
        ...
        try:
            ...
            checks.append(CheckResult(
                name="prompt_eval_error", passed=False, detail=str(e),
            ))
            return
